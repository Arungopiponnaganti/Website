...
export const metadata = {
  title: 'AI Readiness Assessment | MayuraSoft',
  description:
    'Free AI readiness assessment — 18 questions across six dimensions. Get a scored readiness report with personalised recommendations delivered instantly. No signup required.',
  alternates: {
    canonical: 'https://mayurasoft.com/ai-automations/ai-readiness',
  },
  openGraph: {
    images: [{ url: '/assets/og-ai-readiness-assessment.png', width: 1200, height: 630 }],
  },
};
    ...
    <>
      ...
      <div className="custom-dev-page ara-page">
        ...
        <CtaBand
          ...
          primaryBtn={{ href: '/contact', text: 'Book free consultation →', dataCta: 'cta-primary-ara' }}
