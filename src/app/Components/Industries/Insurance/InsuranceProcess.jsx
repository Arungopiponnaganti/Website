...
const STEPS = [
  {
    ...
    desc: 'We assess your insurance technology needs, regulatory requirements, and existing systems. We identify opportunities for digital transformation and create a roadmap aligned with insurance industry standards.',
    outputs: ['Insurance requirements document', 'Regulatory compliance assessment', 'Technical feasibility study', 'Insurance industry compliance checklist'],
    cards: [
      { t: 'Stakeholder workshops', d: 'With insurance executives, IT teams', icon: 'bi-people-fill', theme: 'bento-orange' },
      { t: 'Regulatory review', d: 'Insurance regulations and compliance', icon: 'bi-shield-fill-check', theme: 'bento-purple' },
      { t: 'System audit', d: 'Existing insurance infrastructure', icon: 'bi-building-fill', theme: 'bento-green' }
    ]
  },
  {
    num: '02', title: 'Design', dur: '2–3 weeks',
    desc: 'We design user-centered insurance interfaces, secure data architectures, and integration plans. Our designs prioritize customer experience while maintaining strict security and compliance standards.',
    outputs: ['UX/UI wireframes for insurance interfaces', 'Security architecture design', 'Data flow diagrams', 'Integration specifications'],
    cards: [
      { t: 'User experience design', d: 'Customer and agent workflows', icon: 'bi-person-fill', theme: 'bento-blue' },
      { t: 'Security design', d: 'Encryption and access controls', icon: 'bi-lock-fill', theme: 'bento-pink' },
      { t: 'Compliance review', d: 'Insurance regulatory sign-off', icon: 'bi-check-circle-fill', theme: 'bento-yellow' }
    ]
  },
  {
  ...
  },
  {
    ...
    desc: 'We conduct thorough testing with insurance professionals, security audits, and compliance validation. User testing ensures the solution meets real insurance workflow needs.',
    outputs: ['User acceptance testing results', 'Security audit report', 'Compliance certification', 'Performance validation'],
    cards: [
      { t: 'Insurance testing', d: 'With insurance professionals', icon: 'bi-person-check-fill', theme: 'bento-blue' },
      { t: 'Security audit', d: 'Penetration testing and vulnerability scan', icon: 'bi-bug-fill', theme: 'bento-yellow' },
      { t: 'Compliance certification', d: 'Insurance regulatory documentation', icon: 'bi-file-earmark-check-fill', theme: 'bento-pink' }
    ]
  },
  {
    num: '05', title: 'Deploy', dur: '1–2 weeks',
    desc: 'We manage production deployment with insurance-grade security, monitoring, and support. Our deployment process ensures zero disruption to insurance operations and maintains data integrity.',
...
export default function InsuranceProcess({
  title = "Insurance technology development <br /> <span className=''>with compliance and security at every step</span>",
  subTitle = "Our Insurance Development Process",
  content = "We follow insurance-specific development practices that prioritize customer security, data protection, and regulatory compliance.",
  steps = STEPS
}) {
