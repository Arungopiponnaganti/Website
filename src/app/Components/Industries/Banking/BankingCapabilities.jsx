...
const capabilitiesList = [
  {
    icon: 'bi-bank', title: 'Digital Banking Platforms',
    body: 'Modern online and mobile banking solutions with secure authentication, real-time transactions, and seamless user experiences.',
  },
  {
    icon: 'bi-credit-card', title: 'Payment Processing',
    body: 'Robust payment gateway integration, multi-currency support, fraud detection, and real-time transaction processing.',
  },
  {
    icon: 'bi-shield-check', title: 'Risk Management',
    body: 'Advanced risk assessment, fraud detection, AML compliance, and real-time monitoring with AI-powered analytics.',
  },
  {
    icon: 'bi-graph-up', title: 'Wealth Management',
    body: 'Personalized investment platforms, portfolio tracking, automated advisory services, and comprehensive financial planning tools.',
  },
  {
    icon: 'bi-lock', title: 'Security & Compliance',
    body: 'PCI DSS compliance, end-to-end encryption, secure authentication, and regulatory compliance for financial services.',
  },
  {
    icon: 'bi-diagram-3', title: 'API Integration',
    body: 'Open banking APIs, third-party integrations, payment gateway connections, and seamless system interoperability.',
  }
];

export default function BankingCapabilities({
  title = "Financial technology solutions that drive digital transformation",
  subTitle = "Our Financial Capabilities",
  content = "We build secure, compliant fintech solutions that modernize banking and financial services.",
    ...
    <section id="solutions" className="cd-section py-5 position-relative" style={{ backgroundColor: '#f8f9fa' }}>
      ...
      <DynamicFormModal
        ...
        metadata={{
          ...
          source: 'banking-capabilities',
          formType: `Banking Capability - ${selectedCapability?.title || 'Inquiry'}`
        }}
      />
    </section>
  );
