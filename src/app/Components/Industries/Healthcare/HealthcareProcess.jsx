...
const STEPS = [
  {
    ...
    desc: 'We conduct a thorough assessment of your healthcare technology needs, regulatory requirements, and existing systems. We identify opportunities for digital transformation and create a roadmap aligned with healthcare standards.',
    outputs: ['Healthcare requirements document', 'Regulatory compliance assessment', 'Technical feasibility study', 'HIPAA compliance checklist'],
    cards: [
      { t: 'Stakeholder workshops', d: 'With clinicians, administrators, IT teams', icon: 'bi-people-fill', theme: 'bento-orange' },
      { t: 'Regulatory review', d: 'HIPAA, GDPR, FDA requirements', icon: 'bi-shield-fill-check', theme: 'bento-purple' },
      { t: 'System audit', d: 'Existing EHR and infrastructure', icon: 'bi-file-earmark-medical-fill', theme: 'bento-green' }
    ]
  },
  {
    num: '02', title: 'Design', dur: '2–3 weeks',
    desc: 'We design user-centered healthcare interfaces, secure data architectures, and integration plans. Our designs prioritize patient experience while maintaining strict security and compliance standards.',
    outputs: ['UX/UI wireframes for patient and provider interfaces', 'Security architecture design', 'Data flow diagrams', 'Integration specifications'],
    cards: [
      { t: 'User experience design', d: 'Patient and provider workflows', icon: 'bi-heart-pulse-fill', theme: 'bento-blue' },
      { t: 'Security design', d: 'Encryption and access controls', icon: 'bi-lock-fill', theme: 'bento-pink' },
      { t: 'Compliance review', d: 'HIPAA and regulatory sign-off', icon: 'bi-check-circle-fill', theme: 'bento-yellow' }
    ]
  },
  {
  ...
  },
  {
    ...
    desc: 'We conduct thorough testing with healthcare professionals, security audits, and compliance validation. User testing ensures the solution meets real clinical workflow needs.',
    outputs: ['User acceptance testing results', 'Security audit report', 'Compliance certification', 'Performance validation'],
    cards: [
      { t: 'Clinical testing', d: 'With healthcare professionals', icon: 'bi-person-check-fill', theme: 'bento-blue' },
      { t: 'Security audit', d: 'Penetration testing and vulnerability scan', icon: 'bi-bug-fill', theme: 'bento-yellow' },
      { t: 'Compliance certification', d: 'HIPAA and regulatory documentation', icon: 'bi-file-earmark-check-fill', theme: 'bento-pink' }
    ]
  },
  {
    num: '05', title: 'Deploy', dur: '1–2 weeks',
    desc: 'We manage production deployment with healthcare-grade security, monitoring, and support. Our deployment process ensures zero disruption to patient care and maintains data integrity.',
...
export default function HealthcareProcess({
  title = "Healthcare technology development <br /> <span className=''>with compliance and security at every step</span>",
  subTitle = "Our Healthcare Development Process",
  content = "We follow healthcare-specific development practices that prioritize patient safety, data security, and regulatory compliance.",
  steps = STEPS
}) {
