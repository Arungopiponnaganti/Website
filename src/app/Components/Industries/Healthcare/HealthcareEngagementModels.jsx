...
const models = [
  {
    label: 'Idea stage',
    badge: null,
    headline: 'Healthcare MVP Development',
    desc: 'Validate your healthcare technology idea with a secure, compliant MVP that demonstrates value to patients and providers.',
    includes: [
    ...
    ctaText: 'Start healthcare MVP',
    ctaLink: '/contact?model=healthcare-mvp',
    featured: false
  },
  {
    label: 'Most chosen',
    badge: 'Most chosen',
    headline: 'Healthcare Platform Development',
    desc: 'Build comprehensive healthcare platforms with full EHR integration, patient engagement features, and clinical decision support.',
    includes: [
    ...
    ctaLink: '/contact?model=healthcare-platform',
    featured: true
  },
  {
    label: 'Enterprise',
    badge: null,
    headline: 'Healthcare System Modernization',
    desc: 'Transform legacy healthcare systems into modern, secure, and compliant digital platforms that improve patient care and operational efficiency.',
    includes: [
    ...
    ctaText: 'Modernize healthcare systems',
    ctaLink: '/contact?model=healthcare-modernization',
    featured: false
  }
];

export default function HealthcareEngagementModels({
  subTitle = "How to work with us",
  title = "Healthcare engagement models",
  desc = "Choose the engagement model that fits your healthcare organization's needs and timeline.",
  engagementModels = models,
  pageName = "Healthcare & Life Sciences",
