...
export default function HealthcareHero({
  badgeText = "Healthcare & Life Sciences",
  title = "Patient-centric digital platforms that transform care delivery",
  ...
  formMetadata = { service: 'healthcare-life-sciences', pageTitle: 'Healthcare & Life Sciences' }
}) {
  ...
  return (
    <div className="hero-area style-three align-items-center" style={{ marginTop: '-120px', paddingTop: '280px', position: 'relative', height: 'auto', minHeight: '800px', overflow: 'hidden' }}>
      ...
      <Image
        ...
        alt="Healthcare technology hero background - modern medical technology"
        fill
        priority
        sizes="100vw"
