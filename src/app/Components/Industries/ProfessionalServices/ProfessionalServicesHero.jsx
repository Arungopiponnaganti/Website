...
export default function ProfessionalServicesHero({
  ...
  title = "Digital-first service operations for modern professional firms",
  ...
  stats = [
    ...
    { num: 'Real-time', lbl: 'Client insights' },
    { num: 'Secure', lbl: 'Data protection' }
  ],
  formTitle = "Get a Free Professional Services Consultation",
  formMetadata = { service: 'professional-services', pageTitle: 'Professional Services' }
}) {
  ...
  return (
    <div className="hero-area style-three align-items-center" style={{ marginTop: '-120px', paddingTop: '280px', position: 'relative', height: 'auto', minHeight: '800px', overflow: 'hidden' }}>
      ...
      <Image
        src="/assets/images/professional-services-hero.png"
        alt="Professional services hero background - digital-first service operations"
        fill
        priority
        sizes="100vw"
