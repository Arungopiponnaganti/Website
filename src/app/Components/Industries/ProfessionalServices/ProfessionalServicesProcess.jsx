...
const STEPS = [
  ...
  },
  {
    ...
    cards: [
      { t: 'Secure development', d: 'Following professional services security best practices', icon: 'bi-lock-fill', theme: 'bento-purple' },
      { t: 'Practice integration', d: 'Client management and automation', icon: 'bi-gear-fill', theme: 'bento-green' },
      { t: 'Compliance testing', d: 'Professional services validation and security audits', icon: 'bi-shield-lock-fill', theme: 'bento-orange' }
    ]
  },
  {
  ...
  },
  {
    ...
    cards: [
      ...
      { t: 'Staff training', d: 'Comprehensive training for professional services teams', icon: 'bi-mortarboard-fill', theme: 'bento-purple' }
    ]
  }
];
