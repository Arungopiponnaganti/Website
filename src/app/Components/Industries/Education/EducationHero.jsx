...
export default function EducationHero({
  badgeText = "Education",
  title = "Modern digital learning systems that transform education",
  ...
  stats = [
    ...
    { num: 'Real-time', lbl: 'Collaboration tools' },
    { num: 'Analytics', lbl: 'Student insights' }
  ],
  formTitle = "Get a Free EdTech Consultation",
  formMetadata = { service: 'education', pageTitle: 'Education' }
}) {
  ...
  return (
    <div className="hero-area style-three align-items-center" style={{ marginTop: '-120px', paddingTop: '280px', position: 'relative', height: 'auto', minHeight: '800px', overflow: 'hidden' }}>
      ...
      <Image
        ...
        alt="Education technology hero background - modern digital learning"
        fill
        priority
        sizes="100vw"
