...
export default function EnergyHero({
  badgeText = "Energy & Utilities",
  title = "Smart energy and operations technology for modern utilities",
  ...
  stats = [
    ...
    { num: 'IoT', lbl: 'Connected devices' },
    { num: 'Green', lbl: 'Energy optimization' }
  ],
  formTitle = "Get a Free Energy Tech Consultation",
  formMetadata = { service: 'energy-utilities', pageTitle: 'Energy & Utilities' }
}) {
  ...
  return (
    <div className="hero-area style-three align-items-center" style={{ marginTop: '-120px', paddingTop: '280px', position: 'relative', height: 'auto', minHeight: '800px', overflow: 'hidden' }}>
      ...
      <Image
        ...
        alt="Energy and utilities technology hero background - smart grid and renewable energy"
        fill
        priority
        sizes="100vw"
