...
const STEPS = [
  {
    ...
    desc: 'We assess your energy technology needs, operational requirements, and existing systems. We identify opportunities for digital transformation and create a roadmap aligned with energy industry standards.',
    outputs: ['Energy requirements document', 'Operational assessment', 'Technical feasibility study', 'Energy industry compliance checklist'],
    cards: [
      { t: 'Site assessment', d: 'With energy managers and engineers', icon: 'bi-people-fill', theme: 'bento-orange' },
      { t: 'Infrastructure audit', d: 'Existing energy systems and grid', icon: 'bi-lightning-fill', theme: 'bento-purple' },
      { t: 'IoT evaluation', d: 'Sensor and connectivity assessment', icon: 'bi-wifi-fill', theme: 'bento-green' }
    ]
  },
  {
    num: '02', title: 'Design', dur: '2–3 weeks',
    desc: 'We design smart energy interfaces, IoT architectures, and integration plans. Our designs prioritize operational efficiency while maintaining safety and reliability standards.',
    outputs: ['UX/UI wireframes for energy interfaces', 'IoT architecture design', 'Smart grid workflow diagrams', 'Integration specifications'],
    cards: [
  ...
  },
  {
    ...
    desc: 'We conduct thorough testing with energy professionals, performance validation, and safety verification. User testing ensures the solution meets real energy workflow needs.',
    outputs: ['User acceptance testing results', 'Performance validation report', 'Safety certification', 'Energy efficiency metrics'],
    cards: [
  ...
  },
  {
    ...
    desc: 'We manage production deployment with energy-grade reliability, monitoring, and support. Our deployment process ensures zero disruption to energy operations.',
...
export default function EnergyProcess({
  title = "Energy technology development <br /> <span className=''>with sustainability and efficiency at every step</span>",
  subTitle = "Our Energy Development Process",
  content = "We follow energy-specific development practices that prioritize operational efficiency, sustainability, and reliability.",
  steps = STEPS
}) {
