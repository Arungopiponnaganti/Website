...
export default function HiTechHero({
  badgeText = "Hi Tech",
  title = "Innovative enterprise technology solutions for the digital age",
  ...
  stats = [
    ...
    { num: 'Microservices', lbl: 'Scalable systems' },
    { num: 'DevOps', lbl: 'Automated delivery' }
  ],
  formTitle = "Get a Free Hi-Tech Consultation",
  formMetadata = { service: 'hi-tech', pageTitle: 'Hi Tech' }
}) {
  ...
  return (
    <div className="hero-area style-three align-items-center" style={{ marginTop: '-120px', paddingTop: '280px', position: 'relative', height: 'auto', minHeight: '800px', overflow: 'hidden' }}>
      ...
      <Image
        src="/assets/images/hitech-hero.png"
        alt="Hi tech hero background - innovative enterprise technology"
        fill
        priority
        sizes="100vw"
