...
export default function ManufacturingHero({
  ...
  title = "Smart factory solutions that drive Industry 4.0 transformation",
  ...
  stats = [
    ...
    { num: 'AI-powered', lbl: 'Predictive analytics' }
  ],
  formTitle = "Get a Free Manufacturing Tech Consultation",
  formMetadata = { service: 'manufacturing', pageTitle: 'Manufacturing' }
}) {
  ...
  return (
    <div className="hero-area style-three align-items-center" style={{ marginTop: '-120px', paddingTop: '280px', position: 'relative', height: 'auto', minHeight: '800px', overflow: 'hidden' }}>
      ...
      <Image
        src="/assets/images/manufacturing-hero.png"
        alt="Manufacturing technology hero background - smart factory and automation"
        fill
        priority
        sizes="100vw"
