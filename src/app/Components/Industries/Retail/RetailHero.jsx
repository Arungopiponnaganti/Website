...
export default function RetailHero({
  badgeText = "Retail & Consumer Goods",
  title = "Omnichannel commerce platforms for modern retailers",
  ...
  stats = [
    ...
    { num: 'AI-powered', lbl: 'Customer insights' },
    { num: 'Secure', lbl: 'Payment processing' }
  ],
  formTitle = "Get a Free Retail Tech Consultation",
  formMetadata = { service: 'retail-consumer-goods', pageTitle: 'Retail & Consumer Goods' }
}) {
  ...
  return (
    <div className="hero-area style-three align-items-center" style={{ marginTop: '-120px', paddingTop: '280px', position: 'relative', height: 'auto', minHeight: '800px', overflow: 'hidden' }}>
      ...
      <Image
        ...
        alt="Retail and consumer goods hero background - omnichannel commerce"
        fill
        priority
        sizes="100vw"
