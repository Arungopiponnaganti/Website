...
export default function StartupsHero({
  badgeText = "Startups",
  title = "From MVP to market-ready products for ambitious startups",
  subheadline = "We help startups innovate and disrupt their industries with agile development, emerging technologies, and rapid time-to-market.",
  tags = ['MVP Development', 'Agile', 'Cloud Apps', 'Rapid Launch', 'Scalable Architecture'],
  primaryCta = { text: "Get a free startup consultation →" },
  secondaryCta = { text: "See our process", href: "#process" },
  stats = [
    { num: 'MVP', lbl: 'Launch Planning' },
    { num: 'Lean', lbl: 'Startup Builds' },
    { num: 'Modern', lbl: 'Engineering Practice' },
    { num: 'Outcome', lbl: 'Delivery Focus' }
  ],
  formTitle = "Get a Free Startup Consultation",
  formMetadata = { service: 'startups', pageTitle: 'Startups' }
}) {
  ...
  return (
    <div className="hero-area style-three align-items-center" style={{ marginTop: '-120px', paddingTop: '280px', position: 'relative', height: 'auto', minHeight: '800px', overflow: 'hidden' }}>
      ...
      <Image
        src="/assets/images/energy-hero.png"
        alt="Startup technology hero background - MVP and rapid development"
        fill
        priority
        sizes="100vw"
