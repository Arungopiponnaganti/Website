...
const models = [
  {
    ...
    desc: 'Validate your startup idea with a rapid MVP that demonstrates core value and attracts early adopters or investors.',
    includes: [
    ...
    ctaText: 'Start MVP development',
    ctaLink: '/contact?model=mvp-development',
    featured: false
  },
  {
    label: 'Most chosen',
    badge: 'Most chosen',
    headline: 'Full Product Development',
    desc: 'Build your complete startup product from concept to launch-ready state with full-stack development and ongoing support.',
    includes: [
    ...
    ctaLink: '/contact?model=full-product-development',
    featured: true
  },
  {
    label: 'Scale stage',
    badge: null,
    headline: 'Growth & Scaling',
    desc: 'Scale your existing product with new features, performance optimization, and architecture improvements for growing users.',
    includes: [
    ...
    ctaText: 'Scale my product',
    ctaLink: '/contact?model=growth-scaling',
    featured: false
  }
];

export default function StartupsEngagementModels({
  subTitle = "How to work with us",
  title = "Startup engagement models",
  desc = "Choose the engagement model that fits your startup stage, budget, and timeline.",
